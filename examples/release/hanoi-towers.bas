...
320 PRINT "JUST TAKE MY PUZZLE AND GO HOME.  SO LONG.": END
...
550 GOTO 500
560 PRINT "STOP WASTING MY TIME.  GO BOTHER SOMEONE ELSE.": END
...
790 PRINT "BYE BYE, BIG SHOT.":END
800 FOR R=1 TO 7
...
1370 NEXT K
1380 RETURN
1390 PRINT: PRINT "THANKS FOR PLAYING THE GAME!": PRINT: END
