...
func (p *Parser) initBuiltins() {
	p.unaryBuiltins = map[string]unaryBuiltinFactory{
		...
		"RND": func(expr Expression, line, col int, tok string) Expression {
			return &RndExpr{
				Expr:   expr,
				Line:   line,
				Column: col,
		...
		"SIN": func(expr Expression, line, col int, tok string) Expression {
			return &SinExpr{
				Expr:   expr,
				Line:   line,
				Column: col,
		...
		"COS": func(expr Expression, line, col int, tok string) Expression {
			return &CosExpr{
				Expr:   expr,
				Line:   line,
				Column: col,
		...
		"TAN": func(expr Expression, line, col int, tok string) Expression {
			return &TanExpr{
				Expr:   expr,
				Line:   line,
				Column: col,
		...
		"LOG": func(expr Expression, line, col int, tok string) Expression {
			return &LogExpr{
				Expr:   expr,
				Line:   line,
				Column: col,
		...
		"EXP": func(expr Expression, line, col int, tok string) Expression {
			return &ExpExpr{
				Expr:   expr,
				Line:   line,
				Column: col,
		...
		"CHR$": func(expr Expression, line, col int, tok string) Expression {
			return &ChrExpr{
				Expr:   expr,
				Line:   line,
				Column: col,
