...
func TestLexer_SIN_Function(t *testing.T) {
	input := `10 REM SIN Function
20 PRINT SIN(1.75)
30 A=2.8746841
40 PRINT SIN(A)
50 PRINT SIN(A*3.74)
...
func TestLexer_SIN_Negative_Expression(t *testing.T) {
	input := `10 PRINT SIN(-(A+3.2))`
