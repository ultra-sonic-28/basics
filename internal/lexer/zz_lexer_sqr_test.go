...
func TestLexer_SQR_Function(t *testing.T) {
	input := `10 REM SQR Function
20 PRINT SQR(1.75)
30 A=2.8746841
40 PRINT SQR(A)
50 PRINT SQR(A*3.74)
...
func TestLexer_SQR_Negative_Expression(t *testing.T) {
	input := `10 PRINT SQR(-(A+3.2))`
