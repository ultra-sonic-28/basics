...
func TestLexer_TAN_Function(t *testing.T) {
	input := `10 REM TAN Function
20 PRINT TAN(1.75)
30 A=2.8746841
40 PRINT TAN(A)
50 PRINT TAN(A*3.74)
...
func TestLexer_TAN_Negative_Expression(t *testing.T) {
	input := `10 PRINT TAN(-(A+3.2))`
