...
func TestLexer_HOME_AfterPrint(t *testing.T) {
	input := `10 PRINT "HELLO": HOME`
...
func TestLexer_HOME_MiddleOfLine(t *testing.T) {
	input := `10 PRINT "A": HOME: PRINT "B"`
...
func TestLexer_HOME_Only(t *testing.T) {
	input := `10 HOME`
