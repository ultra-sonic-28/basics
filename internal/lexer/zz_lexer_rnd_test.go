...
func TestLexer_RND_Function(t *testing.T) {
	input := `10 REM RND Function
20 PRINT RND(1.75)
30 A=2.8746841
40 PRINT RND(A)
50 PRINT RND(A*3.74)
...
func TestLexer_RND_Negative_Expression(t *testing.T) {
	input := `10 PRINT RND(-(A+3.2))`
