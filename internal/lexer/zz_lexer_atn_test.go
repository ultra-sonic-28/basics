...
func TestLexer_ATN_Function(t *testing.T) {
	input := `10 REM ATN Function
20 PRINT ATN(1.75)
30 A=2.8746841
40 PRINT ATN(A)
50 PRINT ATN(A*3.74)
...
func TestLexer_ATN_Negative_Expression(t *testing.T) {
	input := `10 PRINT ATN(-(A+3.2))`
