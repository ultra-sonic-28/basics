...
func TestLexer_EXP_Function(t *testing.T) {
	input := `10 REM EXP Function
20 PRINT EXP(1.75)
30 A=2.8746841
40 PRINT EXP(A)
50 PRINT EXP(A*3.74)
...
func TestLexer_EXP_Negative_Expression(t *testing.T) {
	input := `10 PRINT EXP(-(A+3.2))`
