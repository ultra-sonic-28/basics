...
func TestLexer_SGN_Function(t *testing.T) {
	input := `10 REM SGN Function
20 PRINT SGN(1.75)
30 PRINT SGN(-1.75)
40 A=2.8746841
50 PRINT SGN(A)
...
func TestLexer_SGN_Negative_Expression(t *testing.T) {
	input := `10 PRINT SGN(-(A+3.2))`
