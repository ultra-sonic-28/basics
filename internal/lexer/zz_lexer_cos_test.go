...
func TestLexer_COS_Function(t *testing.T) {
	input := `10 REM COS Function
20 PRINT COS(1.75)
30 A=2.8746841
40 PRINT COS(A)
50 PRINT COS(A*3.74)
...
func TestLexer_COS_Negative_Expression(t *testing.T) {
	input := `10 PRINT COS(-(A+3.2))`
