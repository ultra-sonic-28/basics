...
var Font8x8 = &BitmapFont{
	...
	Glyphs: map[rune][]byte{
		...
		// ======================
		// Latin-1 accents (corrigés, MSB → LSB)
		// ======================

		'à': {0x04, 0x08, 0x3C, 0x40, 0x7C, 0x42, 0x7C, 0x00},
		'á': {0x20, 0x10, 0x3C, 0x40, 0x7C, 0x42, 0x7C, 0x00},
		'â': {0x18, 0x24, 0x3C, 0x40, 0x7C, 0x42, 0x7C, 0x00},
		'ä': {0x24, 0x00, 0x3C, 0x40, 0x7C, 0x42, 0x7C, 0x00},

		'ç': {0x00, 0x00, 0x3C, 0x42, 0x02, 0x42, 0x3C, 0x08},

		'è': {0x08, 0x10, 0x3C, 0x42, 0x7E, 0x02, 0x3C, 0x00},
		'é': {0x20, 0x10, 0x3C, 0x42, 0x7E, 0x02, 0x3C, 0x00},
		'ê': {0x18, 0x24, 0x3C, 0x42, 0x7E, 0x02, 0x3C, 0x00},
		'ë': {0x24, 0x00, 0x3C, 0x42, 0x7E, 0x02, 0x3C, 0x00},

		'î': {0x18, 0x24, 0x30, 0x30, 0x30, 0x30, 0x78, 0x00},
		'ï': {0x24, 0x00, 0x30, 0x30, 0x30, 0x30, 0x78, 0x00},

		'ô': {0x18, 0x24, 0x3C, 0x42, 0x42, 0x42, 0x3C, 0x00},
		'ö': {0x24, 0x00, 0x3C, 0x42, 0x42, 0x42, 0x3C, 0x00},

		'ù': {0x08, 0x10, 0x42, 0x42, 0x42, 0x62, 0x5C, 0x00},
		'û': {0x18, 0x24, 0x42, 0x42, 0x42, 0x62, 0x5C, 0x00},
		'ü': {0x24, 0x00, 0x42, 0x42, 0x42, 0x62, 0x5C, 0x00},

		'ÿ': {0x24, 0x00, 0x42, 0x42, 0x3C, 0x10, 0x0C, 0x00},

		'ñ': {0x2C, 0x1A, 0x00, 0x3A, 0x46, 0x46, 0x46, 0x00},

		'ß': {0x38, 0x44, 0x44, 0x78, 0x44, 0x44, 0x3A, 0x00},
